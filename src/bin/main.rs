...
mod tests {
    ...
    fn test_read_save_slot_checksum() {
        ...
        let checksum_data =
            read_checksum_from_file("testdata/vagabond/save_slots/0/checksum.sl2")
    ...
    fn test_read_save_slot() {
        let save_slot_data =
        read_save_slot_from_file("testdata/vagabond/save_slots/0.sl2")
                .expect("data should be present");
    ...
    fn test_read_save_slot_unk01() {
        let unk01 =
        read_unk01_from_file("testdata/vagabond/save_slots/0/unk01.sl2")
                .expect("data should be present");
        println!("{:?}", unk01);
    ...
    fn test_read_save_slot_map_id() {
        let map_id =
        read_unk01_from_file("testdata/vagabond/save_slots/0/MapID.sl2")
                .expect("data should be present");
        println!("{:?}", map_id);
